...
contract JointSavings {
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
         require(recipient == accountOne || recipient == accountTwo, "you are not authorized to make a withdrawal");
         require(amount < contractBalance, "You don't have enough found!");
